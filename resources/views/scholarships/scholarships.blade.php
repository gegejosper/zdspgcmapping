                    ...
                    <table class="table datatable-table">
                        ...
                        @foreach($scholarships as $scholarship)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success" href="{{route ('panel.scholarships.show', $scholarship->id) }}"><i class="fa fa-search"> </i></a>
                                    <a class="btn btn-warning" href="{{route ('panel.scholarships.edit', $scholarship->id) }}"><i class="fa fa-pencil"> </i></a>
